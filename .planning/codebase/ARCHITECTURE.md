...
- Location: `src/agents/web_researcher/tools.py`
...
- Location: `src/utils/`
- Contains: JSON utilities, other cross-cutting helpers
- Used by: All layers
...
2. `WebResearcher.__init__()` initializes PlaywrightTools asynchronously
...
- Examples: `src/agents/web_researcher/web_researcher.py`
- Pattern: LangChain agent factory with custom tools and checkpointer

**PlaywrightTools:**
- Purpose: Manages async Playwright browser lifecycle
- Examples: `src/agents/web_researcher/tools.py`
- Pattern: Async context manager pattern with class methods

**SearchResult:**
- Purpose: Typed response object for search operations
- Examples: `src/agents/web_researcher/web_researcher.py` (line 16-18)
...
**Agent Direct Usage:**
- Location: `src/agents/web_researcher/web_researcher.py`
